                ...
                <div class="col-md-4">
                    ...
                    if (isset($_POST["email"]) && (!empty($_POST["email"]))) {
                        ...
                        if ($error != "") {
                            ...
                            $output.='<p><a href="http://localhost/javapbl/reset-password.php?key=' . $key . '&email=' . $email . '&action=reset" target="_blank">http://localhost/javapbl/reset-password.php?key=' . $key . '&email=' . $email . '&action=reset</a></p>';
                            $body = $output;
                            ...
                            $mail->Port = 587;
                            $mail->IsHTML(true);
                            $mail->From = "";// Enter your email here again
